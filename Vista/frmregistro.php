              ...
              ';
                  ...
                  echo'
                                ...
                                <div class="login-register-btn" >
                                   ...
                                   <a href="frmregistro.php"><font style="vertical-align: inherit; font-size: 12px;"><font style="vertical-align: inherit;"> <strong style="color: green;">Registrarse</strong></font></font></a>
                               </div>
                                ';
                              }
                      ?>                                             
            ...
            <div class="row">
                <div class="col-12">
                        <div class="section-heading">
                            <h1 class="ftco-heading mb-3" data-aos="fade-up" data-aos-delay="500" style="color: white;">Registro</h1>
                        </div>
                    </div>
                </div>
            </div>
