 ...
 */
    ...
    <section class="few-words-from-ceo d-md-flex">
        ...
        <div class="few-words-thumb bg-img wow fadeInRightBig" data-wow-delay="1.1s" style="background-image: url(../Imagenes/Foto.jpg);"></div>
    </section>
    <!-- ***** Few Words Area End ***** -->
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="mosh-about-us-content">
                        ...
                        <p>Coortiendas es una mini empresa que inicia a mediados del año 2014, encabezado por el señor Andres y su familia, esta empresa nace con el objetivo de resolver algunas de las necesidades de los clientes, tales como proveerlos de alimentos y productos de aseo, al su alcance</p>
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    ...
                    <div class="mosh-about-us-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-feature-area d-flex">
                                    ...
                                    <div class="feature-content">
                                        <h5>Misión</h5>
                                        <p>
                                        Se tiene como compromiso ser una empresa dispuesta a superar las expectativas de los clientes, en cuanto a profesionalismo, servicio al cliente, innovación y gestión de ventas, para ofrecer un mejor servicio, bienestar y desarrollo a nuestros asociados, empleados y la comunidad en general.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Single Feature Area -->
                            <div class="col-12 col-sm-6">
                                <div class="single-feature-area d-flex">
                                    <div class="feature-icon mr-30">
                                        <img src="img/core-img/.png" alt="">
                                    </div>
                                    <div class="feature-content">
                                        <h5>Visión</h5>
                                        <p>Ser reconocida como una de las mejores empresas de distribución de supermercados, y crecer como una de las mejores empresas comercializadoras de productos a nivel nacional, que de una presencia innovadora e integral que ofrezca buenos niveles de servicio al cliente, rentabilidad, eficacia y productividad del negocio.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="mosh-subscribe-newsletter-area bg-img bg-overlays-white section_padding_100" style="background-image: url(../Imagenes/Foto.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="subscribe-newsletter-content text-center wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <form action="#">
                            ...
                            <button type="submit" style="background: red;">Suscribete</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md">
              <div class="ftco-footer-widget mb-4">
                ...
                <ul class="list-unstyled">
                  <li><a href="Sobree.php" class="py-2 d-block"><strong style="color: red;"> ¿Quiénes somos?</strong></a></li>
