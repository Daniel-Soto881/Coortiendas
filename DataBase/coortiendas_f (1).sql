...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-02-2021 a las 00:42:22
...
--
CREATE DATABASE `coortiendas_f` DEFAULT CHARACTER SET utf8mb4;
...
(2, 1, 72, 'Mariros@outlook.com', 'Mri456', 'Gran trabajador', 54, NULL),
...
(1110001110, 1, 74, 'Andres@gmail.com', '$2y$10$5qFIuCS.gtDisRFckbJj1eMd6ateMqA2XYb4rNowFJ/mbqCGQldZe', 'Gran Administrador.', 34, NULL);
...
INSERT INTO `inventario` (`Entra_2`, `Id_prod`, `Entr_inv`, `Sal_inv`, `Saldo_inv`) VALUES
(1, 100, 100, 25, 75),
(2, 104, 30, 15, 15),
(3, 101, 25, 7, 18),
(4, 102, 7, 5, 2),
...
(85, 3, 3, 1, 5669, 'honestidad', 'jj@gmail.com', 'jj', '$2y$10$ojMN3bKrtN/yWejc./wsO.5TSFt45/N9yLkyaWGeWYSzDyHQkts/C', '1985-01-15 00:00:00', '2020-10-20 15:33:38');
...
--
ALTER TABLE `solic_emp`
  MODIFY `Id_sol_emp` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=86;
